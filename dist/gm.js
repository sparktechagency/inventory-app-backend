...
function updateRouterFile(folderName, camelCaseName) {
    const routerPath = path_1.default.join(__dirname, 'routes', 'index.ts');
    ...
    if (match) {
        ...
        console.error('Failed to find apiRoutes array. Ensure the index.ts file has a properly defined apiRoutes array.');
        return;
    }
